        ...
        <div class="container">
            ...
            <div class="row m-auto " style="font-size: 18px !important;">
                <div class="col-12">
                    ...
                    <p class="sub-title"> <i class="fas fa-long-arrow-alt-right  text-primary"></i>
                        Your permission to use the website is considered upon the following Use Restrictions or Conduct Restrictions: You agree that you will not under any circumstances:
                        <br>

                        <div class="col-12 d-flex justify-content-end">
                            <div class="col-10 ">
                                1) post any information that is abusive, threatening, religious, defamatory, libelous, or racially, sexually, obscene, or otherwise objectionable and offensive.<br>

                                2) use the website for any unlawful purpose or for the promotion of illegal activities as we are not responsible for the consequences .<br>

                                3) attempt to, or harass, abuse or harm another person or group or invade the other's Privacy.<br>



                                4) interfere or attempt to interfere with the proper functioning of the website.<br>

                                5) make any automated use of the website as it's not allowed by any means, or take any action that we deem to impose or to potentially impose an unreasonable or large load or bypass any robot intention or use any software, technology or devices to spider or crawl the website, or publish or links to harmful content intend to damage or disrupt another user's browser, or share or promote on your website any activities that are Islamically objectionable such as gambling, pornography, usury etc. As this affects our servers or network infrastructure as serious action will be taken Immediately.<br>

                                6) miss any of the agreed lesson fees and payments amounts on the dates outlined in your invoices and 28-day Payment Schedule, if you miss a repayment to us on or before the scheduled date, as set out below in the Payments and Billing section.
                            </div>
                        </div>
                    </p>
                    ...
                    <p class="sub-title"> <i class="fas fa-long-arrow-alt-right  text-primary"></i>
                        Any  advice, statements, Opinions, offers, or other information or content made through the website should not be relied upon.<br>
                        Such authors are only the ones who are responsible for content.<br>
                        There's no consideration for the accuracy, completeness, or usefulness of any information on the website.
                    </p>
                    ...
                    <h3 class="text-primary">Cross Border Transactions:</h3>
                    <div class="col-12 d-flex justify-content-end">
                        <div class="col-10 ">
                        1) Where you use our service to make a Cross Border Transaction, we will bill you in USD and your local bank will be responsible for converting charges to your local currency. The exchange rate used will change regularly to reflect the currency fluctuations in the foreign exchange market.<br>
                        2) No set up fees or foreign exchange commission will be applied to the exchange rate applied to perform the conversion.<br>
                        3) No interest charges are payable by you for the use of our services.<br>
                        </div>
                    </div>
                    ...
                    <p class="sub-title"> <i class="fas fa-long-arrow-alt-right  text-primary"></i>
                        You acknowledge and agree that we and our licensors retain ownership of all intellectual property rights of any kind related to the website.
                    </p>
                    <h3 class="text-primary">WARRANTY DISCLAIMER</h3>
                    <p class="sub-title text-lowercase"> <i class="fas fa-long-arrow-alt-right  text-primary"></i>
                    ...
                    <div class="col-12 d-flex justify-content-end">
                        <div class="col-10 ">
                            1) These Terms shall be governed and construed in accordance with the laws of Egypt, without regard to its conflict of law provisions.<br>
                    ...
                    <h3 class="text-primary">Changes: </h3>
                    <div class="col-12 d-flex justify-content-end">
                        <div class="col-10 ">
                            1) We reserve the right, at our sole discretion, to modify or replace these Terms at any time. If a revision is a material we will try to provide at least 30 days’ notice prior to any new terms taking effect. What constitutes a material change will be determined at our sole discretion.<br>
                    ...
                    <h3 class="text-primary">LIMITATION OF DAMAGES; RELEASE </h3>
                    <p class="sub-title text-lowercase"> <i class="fas fa-long-arrow-alt-right  text-primary"></i>
                    ...
                    <h3 class="text-primary">GENERAL TERMS: </h3>
                    <p class="sub-title text-lowercase"> <i class="fas fa-long-arrow-alt-right  text-primary"></i>
                        YOU ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS OF SERVICE, UNDERSTAND THE TERMS OF SERVICE, AND WILL BE BOUND BY THESE TERMS AND CONDITIONS. YOU FURTHER ACKNOWLEDGE THAT THESE TERMS OF SERVICE TOGETHER WITH THE PRIVACY POLICY AT https://quraanedu.com/privacy-policy/ REPRESENT THE COMPLETE AND EXCLUSIVE STATEMENT OF THE AGREEMENT BETWEEN US AND THAT IT SUPERSEDES ANY PROPOSAL OR PRIOR AGREEMENT ORAL OR WRITTEN, AND ANY OTHER COMMUNICATIONS BETWEEN US RELATING TO THE SUBJECT MATTER OF THIS AGREEMENT.
                    </p>
